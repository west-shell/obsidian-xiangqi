...
**Obsidian 中国象棋插件** 是一款为 Obsidian 笔记软件量身打造的中国象棋渲染引擎，支持以 FEN 和 PGN 格式展示棋局、推演走棋、管理分支变着。支持内置 [皮卡鱼](https://github.com/official-pikafish/Pikafish) (WASM) 引擎分析、语音朗读等功能。
