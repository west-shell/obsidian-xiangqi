...
- **棋盘风格**：自动、浅色、深色、羊皮纸、绿绒布、木质、竹纹——可在设置中切换，也可通过棋盘菜单的色板选择器切换
...
- **记谱方式**：中文（炮二平五）或坐标（h2e6）
- **着法标记**：着法旁显示评估条、标注徽章、评注符号和评论下划线，各项可独立开关
...
- **棋盘风格**：7 种棋盘风格，含木质与竹纹纹理，可从棋盘菜单的色板选择器切换
- **着法列表**：网格对齐的着法分栏，支持中文/坐标记谱，着法旁显示评估、标注、评注符号和评论标记
